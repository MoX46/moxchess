...
class TestPositionToSquare(unittest.TestCase):
    ...
    def test_first_rowo(self):
        """Test first row, 0"""
        self.assertEqual(m.position_to_square((0,4)),('E8'))

    def test_last_row(self):
        """Test last row, 7"""
        self.assertEqual(m.position_to_square((7,7)),('H1'))

    def test_first_col(self):
        """Test first column,  0"""
        self.assertEqual(m.position_to_square((3,0)),('A5'))

    def test_last_col(self):
        """Test last column, 7"""
        self.assertEqual(m.position_to_square((5,7)),('H3'))
...
class TestFenToPieces(unittest.TestCase):
    ...
    def test_valid_fen(self) -> None:
        ...
        expected_list = [
            m.GamePiece((0, 7),m.Piece.QUEEN,m.Color.BLACK),
            m.GamePiece((1, 2),m.Piece.PAWN,m.Color.WHITE),
            m.GamePiece((1, 4),m.Piece.BISHOP,m.Color.BLACK),
            m.GamePiece((2, 6),m.Piece.KNIGHT,m.Color.BLACK),
            m.GamePiece((3, 1),m.Piece.QUEEN,m.Color.WHITE),
            m.GamePiece((3, 5),m.Piece.BISHOP,m.Color.WHITE),
            m.GamePiece((4, 2),m.Piece.KNIGHT,m.Color.WHITE),
            m.GamePiece((4, 6),m.Piece.KING,m.Color.BLACK),
            m.GamePiece((5, 0),m.Piece.PAWN,m.Color.BLACK),
            m.GamePiece((5, 4),m.Piece.KING,m.Color.WHITE),
            m.GamePiece((7, 6),m.Piece.ROOK,m.Color.WHITE),
            m.GamePiece((7, 7),m.Piece.ROOK,m.Color.BLACK)
        ]
